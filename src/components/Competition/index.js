  ...
  function Competetion() {
    ...
    const data = {
      ...
      objectives :[
        ...
        Rewards:[      "Unlock Hidden Strategies: Discover the often-overlooked tactics that can make a substantial difference in the citation rates of academic publications",
        "Craft Compelling Titles and Abstracts: Learn how to craft titles and abstracts that are not only informative but also attention grabbing, enticing fellow researchers to explore your work further",
        "Navigate Journal Selection: Understand the nuances of choosing the right journals for your research, optimizing visibility, and targeting the right audience",],

        Requirement:[      "Unlock Hidden Strategies: Discover the often-overlooked tactics that can make a substantial difference in the citation rates of academic publications",
        "Craft Compelling Titles and Abstracts: Learn how to craft titles and abstracts that are not only informative but also attention grabbing, enticing fellow researchers to explore your work further",
        "Navigate Journal Selection: Understand the nuances of choosing the right journals for your research, optimizing visibility, and targeting the right audience",],
